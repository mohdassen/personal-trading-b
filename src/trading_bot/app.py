...
def run() -> int:
    ...
    account_equity = float(os.getenv("ACCOUNT_EQUITY_USD", settings.get("account_equity_usd", 10000)))
    risk_pct = float(os.getenv("RISK_PER_TRADE_PCT", settings.get("risk_per_trade_pct", 0.5)))
