...
SECTOR_ETF={
 'MEGA_TECH':'XLK','SEMICONDUCTORS':'SMH','CLOUD_SECURITY':'CIBR','TRAVEL_MOBILITY':'PEJ',
 'CONSUMER_RETAIL':'XLY','FINANCIALS':'XLF','HEALTHCARE':'XLV','ENERGY':'XLE','INDUSTRIALS':'XLI','MEDIA_TELECOM':'XLC','OTHER':'SPY'
}
