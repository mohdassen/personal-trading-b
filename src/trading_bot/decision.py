...
def _simple_view(signal, action, score, event_level, risk_pct, low, high, stop, target1):
    ...
    elif action=="WAIT_FOR_ENTRY":decision_ar="انتظر السعر المناسب";decision_en="WAIT";next_step=f"لا تشترِ الآن. انتظر وصول السعر إلى منطقة ${low:.2f}–${high:.2f}."
